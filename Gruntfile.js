...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      injectJS: {
        files: [
          '<%= yeoman.client %>/{app,assets}/**/*.js',
          '!<%= yeoman.client %>/{app,assets}/**/*.spec.js',
          '!<%= yeoman.client %>/{app,assets}/**/*.mock.js',
          '!<%= yeoman.client %>/app/app.js'],
        tasks: ['injector:scripts']
      },
      injectCss: {
        files: [
          '<%= yeoman.client %>/{app,assets}/**/*.css'
        ],
        tasks: ['injector:css']
      },
      mochaTest: {
      ...
      livereload: {
        files: [
          '{.tmp,<%= yeoman.client %>}/{app,assets}/**/*.css',
          '{.tmp,<%= yeoman.client %>}/{app,assets}/**/*.html',
          '{.tmp,<%= yeoman.client %>}/{app,assets}/**/*.js',
          '!{.tmp,<%= yeoman.client %>}{app,assets}/**/*.spec.js',
          '!{.tmp,<%= yeoman.client %>}/{app,assets}/**/*.mock.js',
